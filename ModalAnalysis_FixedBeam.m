...
n_damage = input('Enter the member number which is damaged: ');
...
% FURTHER CALCULATIONS IS ONLY FOR A FIXED BEAM


% ENTERING BOUNDARY CONDITIONS

K_22_dam = K_dam(3:2*n_node-2,3:2*n_node-2);
K_22 = K(3:2*n_node-2,3:2*n_node-2);
M_22 = M(3:2*n_node-2,3:2*n_node-2);
...
evec_transverse = evec(1:2:(2*n_node - 4),:);
evec_transverse_dam = evec_dam(1:2:(2*n_node - 4),:);
